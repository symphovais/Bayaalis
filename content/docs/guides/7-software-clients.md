...
## Creating and downloading Jabra+ desktop
...
- On the left-hand navigation bar, click Personal devices > Desktop clients
- Click Create desktop client
- In the Create desktop client dialog box, in the Name field, enter a name for your client for example, Human Resources, and click Next
...
- In the Download desktop client dialog box, click Download . The Jabra+ desktop app installation file is downloaded to your default Downloads folder associated with your Internet browser.
...
## Creating and downloading the Meeting room software client
...
- On the left-hand navigation bar, click Meeting rooms > Room clients
- Click Create meeting room client
- In the Create meeting room client dialog box, in the Name field, enter a name for your client for example, Meeting room 1 client, and click Next
...
- In the Download meeting room client dialog box, click Download . The installation file is downloaded to your default Downloads folder associated with your web browser.
...
## Jabra+ for installers software client or using a provisioning code
...
## Viewing or generating a provisioning code
...
- Log in to the Jabra+ platform as an owner or member with edit rights
- On the left-hand navigation bar, click Meeting rooms > Room inventory
- On the left-hand Locations bar, at the top of the list, click the action menu (three-dot menu) next to the name of your organization
- Click Provisioning code
- In the Provisioning code dialog box, in the Provisioning code field, copy or note down the alphanumeric code
- If you must generate a new code, in the Provisioning code dialog box, click Generate a new code
...
- Launch Jabra Xpress
- On the left-hand navigation bar, click Devices > Manage
- Click on the relevant Jabra device and manually copy the settings using your preferred method. For example, you can copy the settings to a text or spreadsheet. After provisioning your Jabra device to the Jabra+ platform, ensure you create a configuration with the settings from Jabra Xpress .
...
- Launch Jabra Xpress
- On the left-hand navigation bar, click Analytics > Room Insights
- In the Select Time Range ribbon, on the right-hand side of the screen, click Export
- Enter a name for the file and click Save
- Ensure you uninstall Jabra Xpress
...
- On the left-hand navigation bar, click the name of the organization you are currently the owner of or belong to, and then Organization settings
- On the Organization Settings page, in the Metadata collection section, uncheck the checkboxes, i.e., Computer information, Location , , and Username
- To confirm your metadata collection choices, click Save
...
- On the left-hand navigation bar, click Meeting rooms > Room configurations , or in the case of personal devices, click Devices > Configurations
- On the Room configurations/Configurations page, click the pane with the configuration name you would like to duplicate
- On the configuration page you would like to duplicate, click the action menu (three-dot menu)
- Click Duplicate configuration
- In the Duplicate configuration dialog box, in the Configuration name field, enter a name. Optionally, in the Description field, enter a description for the duplicated room configuration/configuration.
- Click Save Changes
...
- On the left-hand navigation bar, click Meeting rooms > Room inventory
- On the Meeting room inventory table, check the checkbox for the relevant room name(s)
- In the bottom ribbon, click Assign configuration
- In the Change room configuration dialog box, in the drop-down menu, select the configuration name you created, and click Apply to confirm. Now, you have bulk-assigned a Room configuration you created for one or many rooms.
...
- On the Room page, click the action menu on the relevant pane that shows the Jabra meeting room device you would like to reboot and click Reboot device
- In the Are you sure you want to reboot? dialog box, click Confirm
...
- Insert the Jabra Link Bluetooth adapter into a USB port on your computer and ensure the Jabra personal device is switched ON and within range
- Put your Jabra personal device in pairing mode
- On your Windows system tray, right click the Jabra+ app icon and click Pairing
- When the app detects your Jabra Link Bluetooth adapter it searches for your Jabra personal device. When detected, in the Available devices dialog box, click the Jabra device(s) you would like to pair. When pairing is successful, you see a Device connected message.
...
- If your firmware update fails, a notification informs you, and you can begin the recovery process. In the Something went wrong dialog box, click Recover device

Note

You may be asked to unplug or undock all other Jabra devices to start the recovery.

- Recovery in progress dialog box shows the duration of the recovery. When it is finished, in the Recovery complete dialog box, click OK
