...
date: 2025-06-23T14:40:17.826Z
weight: 1
---

#### Introduction to Jabra+ and the Jabra+ platform
...
- - Automatic migration of room analytics data is not possible between Jabra Xpress and Jabra+ . An admin user ( owner or member with edit rights ) can export settings and room information from Jabra Xpress to the Jabra+ platform, however this must be done manually.
...
### Compatibility with other device management systems
...
### Browser and security requirements to access Jabra+ platform
...
When launched, the Installer unpacks dependencies, including digitally signed Dynamic Link Libraries (*.dll) and executable (*.exe) files.
